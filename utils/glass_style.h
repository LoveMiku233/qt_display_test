...
namespace GlassStyle {
    ...
    // ========== 背景色 (渐变基础) ==========
    const QString BG_GRADIENT_START = "#0f0c29";    // 深紫黑
    const QString BG_GRADIENT_MID = "#302b63";      // 紫色
    const QString BG_GRADIENT_END = "#24243e";      // 深蓝紫
    
    // ========== 玻璃效果色 ==========
    const QString GLASS_BG = "rgba(255, 255, 255, 0.05)";       // 玻璃背景
    const QString GLASS_BG_HOVER = "rgba(255, 255, 255, 0.1)";  // 悬停玻璃背景
    const QString GLASS_BG_ACTIVE = "rgba(255, 255, 255, 0.15)"; // 激活玻璃背景
    const QString GLASS_BORDER = "rgba(255, 255, 255, 0.18)";   // 玻璃边框
    const QString GLASS_BORDER_HOVER = "rgba(255, 255, 255, 0.3)"; // 悬停玻璃边框
    ...
    const QString MAIN_BACKGROUND = R"(
        ...
        QWidget {
            font-family: "Microsoft YaHei", "SimHei", "WenQuanYi Micro Hei", "Segoe UI", sans-serif;
        }
    )";
    ...
    const QString NAV_BUTTON_GLASS = R"(
        ...
        QPushButton:checked {
            background: qlineargradient(x1:0, y1:0, x2:1, y2:0,
                stop:0 rgba(79, 172, 254, 0.4), stop:1 rgba(0, 242, 254, 0.2));
            color: #ffffff;
    ...
    const QString GLASS_DIALOG = R"(
        QDialog {
            background: qlineargradient(x1:0, y1:0, x2:1, y2:1,
                stop:0 rgba(15, 12, 41, 0.98), stop:0.5 rgba(48, 43, 99, 0.98), stop:1 rgba(36, 36, 62, 0.98));
        }
        QDialog QLabel {
            color: rgba(255, 255, 255, 0.9);
            background: transparent;
